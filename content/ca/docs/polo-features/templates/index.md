...
This is read as: _concatenate (join) the operation references separated by commas then add an ampersand before the last reference using the shortLabel_ and will produce a QSL Message for each POTA log like this:
